defmodule TermigateWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: TermigateWeb.Gettext
  ...
  def header(assigns) do
    ~H"""
    <header class={[@actions != [] && "flex items-center justify-between gap-4", "pb-4"]}>
      <div>
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(TermigateWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(TermigateWeb.Gettext, "errors", msg, opts)
    end
  end
